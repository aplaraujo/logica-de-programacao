...
public class Main {
    public static void main(String[] args) {
        ...
        // Criar o vetor grupoA com 10 elementos (números inteiros)
        int[] grupoA = new int[10];

        // Criar o vetor grupoB com 10 elementos (números inteiros)
        int[] grupoB = new int[10];

        // Criar o vetor grupoC com 20 elementos (números inteiros)
